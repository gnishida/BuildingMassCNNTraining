...
public:
    ...
    void setupUi(QDialog *ImageGenerationDialog)
    {
        ...
        ImageGenerationDialog->resize(579, 568);
        ...
        label_6->setGeometry(QRect(20, 170, 91, 16));
        ...
        lineEditTotalNumImages->setGeometry(QRect(190, 380, 81, 20));
        label_29 = new QLabel(ImageGenerationDialog);
        label_29->setObjectName(QStringLiteral("label_29"));
        label_29->setGeometry(QRect(20, 380, 171, 16));
        ...
        checkBoxGenerateMean->setGeometry(QRect(370, 380, 101, 17));
        label_30 = new QLabel(ImageGenerationDialog);
        label_30->setObjectName(QStringLiteral("label_30"));
        label_30->setGeometry(QRect(20, 140, 91, 16));
        radioButtonStreetView = new QRadioButton(ImageGenerationDialog);
        ...
        radioButtonAerialView = new QRadioButton(ImageGenerationDialog);
        radioButtonAerialView->setObjectName(QStringLiteral("radioButtonAerialView"));
        radioButtonAerialView->setGeometry(QRect(260, 140, 82, 17));
        ...
        QWidget::setTabOrder(checkBoxCentering, radioButtonStreetView);
    ...
    void retranslateUi(QDialog *ImageGenerationDialog)
    {
        ...
        label_30->setText(QApplication::translate("ImageGenerationDialog", "Camera type:", 0));
        radioButtonStreetView->setText(QApplication::translate("ImageGenerationDialog", "Street view", 0));
        radioButtonAerialView->setText(QApplication::translate("ImageGenerationDialog", "Aerial view", 0));
