...
public:
    ...
    void setupUi(QDialog *ImageGenerationDialog)
    {
        ...
        lineEditTotalNumImages->setGeometry(QRect(190, 350, 81, 20));
        ...
        QWidget::setTabOrder(lineEditFovSample, lineEditXMin);
